...
public class PayloadDataHandler {
     ...
     *
     */
    public static String PayloadToString(PayloadHandler payload) {
     ...
     * @param payload
     */
    public static void StringToPayload(String message, PayloadHandler payload){
     ...
     * @param payload
     */
    public static void PayloadToFile(String fileToCreate, PayloadHandler payload) {
        try{
